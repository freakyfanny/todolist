...
const AddTodo = () => {
  ...
  return (
    <div className="flex items-center justify-center align-middle my-2">
      <input
        type="text"
        className="dark:bg-gray-700 dark:text-white dark:placeholder-white rounded-md block w-full py-2 px-4 mr-1 bg-white border border-black-900 text-sm shadow-md placeholder-slate-400
